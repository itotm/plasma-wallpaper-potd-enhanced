function buildUrl(market) {
    return "https://www.eso.org/public/images/potw/feed/";
}

function buildFallbackUrl(market) {
    return "https://www.eso.org/public/images/potw/";
}
...
function parseResponse(responseText, isPortrait) {
    ...
    // Skip non-image entries (occasional videos)
    if (!/\.(jpg|jpeg|png)$/i.test(screenUrl)) {
        return null;
    }
...
function parseFallbackResponse(responseText, isPortrait) {
    ...
    var id = match[1];
    var imageUrl = "https://cdn.eso.org/images/large/" + id + ".jpg";
    var thumbnailUrl = "https://cdn.eso.org/images/screen/" + id + ".jpg";
    ...
    return {
        ...
        description: "",
        copyright: "ESO",
        copyrightLink: "https://www.eso.org/public/images/" + id + "/",
        copyrightText: "ESO"
    };
}
